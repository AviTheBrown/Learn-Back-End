...
func process2(w http.ResponseWriter, r *http.Request) {
	// creates a key value pair map { map[stirng][function] } template function
	...
	// and adds the string function map (funcMap) that is attached
	// to the template "tmpl.html with the .Funcs() method
